...
class Translations {
    private static $translations = [
        'en' => [
            ...
            'assignment_balance' => 'Assignment Load Balancing',
            'assignment_balance_description' => 'Balance assignments across teams to ensure fairness',
            'consecutive_assignments' => 'Consecutive Assignment Control',
            'consecutive_assignments_description' => 'Control how many consecutive matches a team can be assigned',
            'weekend_restrictions' => 'Weekend Assignment Restrictions',
            'weekend_restrictions_description' => 'Control weekend assignment patterns and prevent overloading',
            'team_unavailability' => 'Team Unavailability',
            'team_unavailability_description' => 'Mark specific teams as unavailable for certain dates or periods',
            'go_match_grouping' => 'GO Competition Grouping',
            'go_match_grouping_description' => 'Ensure GO competition matches are assigned consistently',
            'team_restrictions' => 'Team Assignment Restrictions',
            'team_restrictions_description' => 'Prevent teams from jury duties in specific scenarios',
            'home_team_restriction' => 'Home Team Cannot Jury Own Match',
            'home_team_restriction_description' => 'Teams cannot jury their own matches (home or away)',
            'away_match_conflict' => 'Away Match Day Restriction',
            'away_match_conflict_description' => 'Teams cannot jury when they have away matches on the same day',
            'dedicated_team_assignment' => 'Dedicated Team Assignment',
            'dedicated_team_assignment_description' => 'Teams dedicated to specific teams can only jury their matches',
            'cross_day_restrictions' => 'Cross-Day Assignment Restrictions',
            'cross_day_restrictions_description' => 'Prevent assignments on consecutive days or specific patterns',
            'proximity_preference' => 'Proximity and Efficiency',
            'proximity_preference_description' => 'Prefer assignments that group matches efficiently',
            'point_balancing' => 'Point System Balancing',
            'point_balancing_description' => 'Balance points earned across teams for fairness',
            'quiet_day_optimization' => 'Quiet Day Optimization',
            'quiet_day_optimization_description' => 'Optimize assignments for days with few matches',
            'da1_da2_restriction' => 'Da1/Da2 Mutual Exclusion',
            'da1_da2_restriction_description' => 'Da1 and Da2 teams cannot jury each other\'s matches',
            'h1_h2_special_rules' => 'H1/H2 Special Assignment Rules',
            'h1_h2_special_rules_description' => 'Special rules for H1 and H2 team assignments',
            'workload_distribution' => 'Historical Workload Distribution',
            'workload_distribution_description' => 'Consider historical assignments when distributing new ones',
            'custom_constraint' => 'Custom Python Constraint',
            'custom_constraint_description' => 'Define a custom constraint with Python-like logic',
            ...
            'team_dedication' => 'Team Dedication',
            'optimization' => 'Optimization',
            'fairness_category' => 'Fairness',
            'special_rules' => 'Special Rules',
            'advanced_category' => 'Advanced',
            
            // Rule types
            'forbidden_hard_constraint' => 'Forbidden (Hard Constraint)',
            ...
            'create_advanced_constraint_tables' => 'Create tables for advanced constraint system',
            'migration_successful' => 'Migration completed successfully!',
            'migration_failed' => 'Migration failed',
            'migration_error' => 'Migration error',
            'advanced_constraint_system_migration' => 'Advanced Constraint System Migration',
            'migration_description' => 'The advanced constraint editor requires additional database tables. This migration will create the necessary tables and add default constraint templates.',
            'migration_complete' => 'Migration Complete',
            'rules_found' => '%d constraint rules found in database',
            'open_constraint_editor' => 'Open Constraint Editor',
            'migration_required' => 'Migration Required',
            'migration_required_description' => 'The planning_rules table does not exist. Please run the migration to create it.',
            'database_error' => 'Database Error',
            'what_will_be_created' => 'What Will Be Created',
            'planning_rules_table' => 'Planning Rules Table',
            'planning_rules_description' => 'Main table for storing advanced constraint rules with support for complex parameters and rule types.',
            'default_constraint_templates' => 'Default Constraint Templates',
            'default_templates_description' => 'Pre-configured constraint templates based on your Python optimization model.',
            'python_integration' => 'Python Integration',
            'python_integration_description' => 'Full compatibility with your OR-Tools constraint solver and Python optimization engine.',
            ...
            'advanced_constraint_editor' => 'Advanced Constraint Editor',
            'advanced_constraint_editor_description' => 'Create, edit, and manage advanced constraints for the Python optimization model',
            'import_python_constraints' => 'Import Python Constraints',
            'constraint_parameters' => 'Constraint Parameters',
            'existing_constraints' => 'Existing Constraints',
            'no_constraints_found' => 'No constraints found. Create your first constraint to get started.',
            'constraint_created_success' => 'Constraint created successfully',
        ...
        'nl' => [
            ...
            'advanced_constraints' => 'Geavanceerde Beperkingen',
            'analysis' => 'Analyse',
            ...
            // Advanced constraint types
            'assignment_balance' => 'Toewijzing Balancering',
            'assignment_balance_description' => 'Balanceer toewijzingen tussen teams voor eerlijkheid',
            'consecutive_assignments' => 'Opeenvolgende Toewijzingen Controle',
            'consecutive_assignments_description' => 'Controleer hoeveel opeenvolgende wedstrijden een team kan worden toegewezen',
            'weekend_restrictions' => 'Weekend Toewijzing Beperkingen',
            'weekend_restrictions_description' => 'Controleer weekend toewijzingspatronen en voorkom overbelasting',
            'team_unavailability' => 'Team Onbeschikbaarheid',
            'team_unavailability_description' => 'Markeer specifieke teams als onbeschikbaar voor bepaalde data of periodes',
            'go_match_grouping' => 'GO Competitie Groepering',
            'go_match_grouping_description' => 'Zorg ervoor dat GO competitiewedstrijden consistent worden toegewezen',
            'team_restrictions' => 'Team Toewijzing Beperkingen',
            'team_restrictions_description' => 'Voorkom teams van jury taken in specifieke scenario\'s',
            'home_team_restriction' => 'Thuisteam Kan Eigen Wedstrijd Niet Jureren',
            'home_team_restriction_description' => 'Teams kunnen hun eigen wedstrijden niet jureren (thuis of uit)',
            'away_match_conflict' => 'Uitwedstrijd Dag Beperking',
            'away_match_conflict_description' => 'Teams kunnen niet jureren wanneer ze uitwedstrijden hebben op dezelfde dag',
            'dedicated_team_assignment' => 'Toegewijde Team Toewijzing',
            'dedicated_team_assignment_description' => 'Teams toegewezen aan specifieke teams kunnen alleen hun wedstrijden jureren',
            'cross_day_restrictions' => 'Dagoverschrijdende Toewijzing Beperkingen',
            'cross_day_restrictions_description' => 'Voorkom toewijzingen op opeenvolgende dagen of specifieke patronen',
            'proximity_preference' => 'Nabijheid en Efficiëntie',
            'proximity_preference_description' => 'Verkies toewijzingen die wedstrijden efficiënt groeperen',
            'point_balancing' => 'Puntensysteem Balancering',
            'point_balancing_description' => 'Balanceer behaalde punten tussen teams voor eerlijkheid',
            'quiet_day_optimization' => 'Rustige Dag Optimalisatie',
            'quiet_day_optimization_description' => 'Optimaliseer toewijzingen voor dagen met weinig wedstrijden',
            'da1_da2_restriction' => 'Da1/Da2 Wederzijdse Uitsluiting',
            'da1_da2_restriction_description' => 'Da1 en Da2 teams kunnen niet elkaars wedstrijden jureren',
            'h1_h2_special_rules' => 'H1/H2 Speciale Toewijzing Regels',
            'h1_h2_special_rules_description' => 'Speciale regels voor H1 en H2 team toewijzingen',
            'workload_distribution' => 'Historische Werklast Verdeling',
            'workload_distribution_description' => 'Overweeg historische toewijzingen bij het verdelen van nieuwe',
            'custom_constraint' => 'Aangepaste Python Beperking',
            'custom_constraint_description' => 'Definieer een aangepaste beperking met Python-achtige logica',
            
            // Constraint categories
            'load_balancing' => 'Verdeling',
            'scheduling' => 'Planning',
            'weekend_rules' => 'Weekend Regels',
            'availability' => 'Beschikbaarheid',
            'competition_rules' => 'Competitie Regels',
            'conflict_prevention' => 'Conflict Preventie',
            'team_dedication' => 'Team Toewijzing',
            'optimization' => 'Optimalisatie',
            'fairness_category' => 'Eerlijkheid',
            'special_rules' => 'Speciale Regels',
            'advanced_category' => 'Geavanceerd',
            
            // Rule types
            'forbidden_hard_constraint' => 'Verboden (Harde Beperking)',
            'not_preferred' => 'Niet Gewenst',
            'most_preferred' => 'Meest Gewenst',
            ...
            'load_balancing' => 'Belasting Balancering',
            
            // Advanced Constraint Editor
            'advanced_constraint_editor' => 'Geavanceerde Beperkingen Editor',
            'advanced_constraint_editor_description' => 'Maak, bewerk en beheer geavanceerde beperkingen voor het Python optimalisatie model',
            'import_python_constraints' => 'Python Beperkingen Importeren',
            'constraint_parameters' => 'Beperkings Parameters',
            'existing_constraints' => 'Bestaande Beperkingen',
            'no_constraints_found' => 'Geen beperkingen gevonden. Maak je eerste beperking om te beginnen.',
            'constraint_created_success' => 'Beperking succesvol aangemaakt',

...
class Translations {
    private static $translations = [
        'en' => [
            ...
            'constraint_sat' => 'CP-SAT (complex)',
            'linear_solver' => 'Linear (fast)',
            ...
            'refresh' => 'Refresh',
            'generating_autoplan' => 'Generating autoplan...',
            'please_wait_optimization' => 'Please wait while we generate the optimal assignments',
            'current_auto_assignments' => 'Current auto assignments',
            'loading_assignments' => 'Loading assignments...',
            'no_auto_assignments_yet' => 'No auto-generated assignments yet. Click "Run Auto Assignment" to create optimal assignments.',
            'optimization_success' => 'Successfully generated autoplan with %d assignments',
            'optimization_failed' => 'Autoplanning failed: {error}',
            'clear_assignments_confirm' => 'Are you sure you want to clear all auto-generated assignments?',
            'assignments_cleared' => 'Cleared {count} assignments',
            ...
            'python_optimization' => 'Python Optimization Engine',
            'solver_type' => 'Solver Type',
            'auto_select' => 'Auto Select',
            'linear_solver' => 'Linear Programming',
            'constraint_sat' => 'Constraint Satisfaction',
            'timeout_seconds' => 'Timeout (seconds)',
            'validate_constraints' => 'Validate Constraints',
            'preview_optimization' => 'Preview Optimization',
            'run_optimization' => 'Run Optimization',
            'run_optimization_confirm' => 'This will create new jury assignments. Continue?',
            'optimization_success' => 'Optimization completed successfully.',
            'optimization_failed' => 'Optimization failed',
            'assignments_imported' => 'assignments imported',
            'validation_passed' => 'All constraints are valid',
            'validation_failed' => 'Constraint validation failed',
            'active_constraints' => 'Active Constraints',
            'errors' => 'Errors',
            'warnings' => 'Warnings',
            'optimization_preview' => 'Optimization Preview',
        ...
        'nl' => [
            ...
            'solver_type' => 'Oplosser type',
            'auto_select' => 'Auto selectie (aanbevolen)',
            'constraint_sat' => 'CP-SAT (complex)',
            'linear_solver' => 'Lineair (snel)',
            'timeout_seconds' => 'Tijdslimiet',
            'minute' => 'Minuut',
            'minutes' => 'Minuten',
            'options' => 'Opties',
            'verbose_output' => 'Uitgebreide uitvoer',
            'refresh' => 'Vernieuwen',
            'generating_autoplan' => 'Autoplan genereren...',
            'please_wait_optimization' => 'Even geduld terwijl we de optimale toewijzingen genereren',
            'current_auto_assignments' => 'Huidige auto toewijzingen',
            'loading_assignments' => 'Toewijzingen laden...',
            'no_auto_assignments_yet' => 'Nog geen automatisch gegenereerde toewijzingen. Klik "Automatische Toewijzing Uitvoeren" om optimale toewijzingen te maken.',
            'optimization_success' => 'Autoplan succesvol gegenereerd met %d toewijzingen',
            'optimization_failed' => 'Automatische planning mislukt: {error}',
            'clear_assignments_confirm' => 'Weet je zeker dat je alle automatisch gegenereerde toewijzingen wilt wissen?',
            'assignments_cleared' => '%d toewijzingen gewist',
            'assignments_cleared' => 'Cleared %d assignments',

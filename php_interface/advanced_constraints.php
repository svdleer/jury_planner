    ...
    if (isset($_POST['action'])) {
        switch ($_POST['action']) {
            case 'update_constraint':
                ...
                if ($result) {
                    $_SESSION['success'] = 'Constraint updated successfully!';
                } else {
                    $_SESSION['error'] = 'Failed to update constraint.';
                }
            ...
            case 'bulk_enable':
                ...
                $_SESSION['success'] = 'Selected constraints enabled!';
                header('Location: advanced_constraints.php');
                exit;
                break;
            ...
            case 'bulk_disable':
                ...
                $_SESSION['success'] = 'Selected constraints disabled!';
                header('Location: advanced_constraints.php');
                exit;
                break;
        }
                    ...
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Total Constraints</dt>
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Hard Rules</dt>
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Soft Rules</dt>
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo $constraint['enabled'] ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'; ?>">
                                                    ...
                                                    <?php echo $constraint['enabled'] ? 'Enabled' : 'Disabled'; ?>
                                                </span>
                                                
                                                <!-- Weight -->
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                    <i class="fas fa-weight-hanging mr-1"></i>
                                                    Weight: <?php echo number_format($constraint['weight'], 2); ?>
                                                </span>
                                                ...
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                                                    ...
                                                    Penalty: <?php echo $constraint['penalty_points']; ?>
                                                </span>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="mt-2 text-xs text-gray-500">
                                                Code: <code class="bg-gray-100 px-1 rounded"><?php echo $constraint['constraint_code']; ?></code>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <form method="POST" class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <select name="constraint_type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                                    <option value="hard" <?php echo $constraint['constraint_type'] === 'hard' ? 'selected' : ''; ?>>Hard (Must not be violated)</option>
                                                    <option value="soft" <?php echo $constraint['constraint_type'] === 'soft' ? 'selected' : ''; ?>>Soft (May be violated with penalty)</option>
                                                </select>
                                            </div>
                                            ...
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700">Penalty Points</label>
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center">
                                                ...
                                                <label for="enabled_<?php echo $constraint['id']; ?>" class="ml-2 text-sm text-gray-700">Enable this constraint</label>
                                            </div>
            ...
            return {
                ...
                bulkEnable() {
                    if (this.selectedConstraints.length === 0) {
                        alert('Please select constraints to enable.');
                        return;
                    }
                ...
                bulkDisable() {
                    if (this.selectedConstraints.length === 0) {
                        alert('Please select constraints to disable.');
                        return;
                    }

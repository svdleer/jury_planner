...
class Translations {
    private static $translations = [
        ...
        'nl' => [
            ...
            'advanced_constraint_editor' => 'Geavanceerde Beperking Editor',
            'constraint_type' => 'Beperkingstype',
            'constraint_parameters' => 'Parameters',
            'add_constraint' => 'Beperking Toevoegen',
            'edit_constraint' => 'Beperking Bewerken',
            'delete_constraint' => 'Beperking Verwijderen',
            'constraint_weight' => 'Gewicht',
            'constraint_enabled' => 'Ingeschakeld',
            'constraint_name' => 'Naam',
            'constraint_description' => 'Beschrijving',
            'import_from_python' => 'Importeer uit Python',
            'export_to_python' => 'Exporteer naar Python',
            'constraint_template' => 'Sjabloon',
            'save_constraint' => 'Beperking Opslaan',
            'cancel' => 'Annuleren',
            'confirm_delete' => 'Weet je zeker dat je deze beperking wilt verwijderen?',
            'constraint_saved' => 'Beperking succesvol opgeslagen',
            'constraint_deleted' => 'Beperking succesvol verwijderd',
            'constraint_imported' => 'Beperkingen succesvol geïmporteerd',
            'import_error' => 'Fout bij importeren van beperkingen',
            'invalid_parameters' => 'Ongeldige parameters',
            'constraint_exists' => 'Beperking bestaat al',
        ]
    ];
